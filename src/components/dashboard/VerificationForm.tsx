...
export default function VerificationForm({ onSuccess, isLoading }: VerificationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success && data.participantInfo) {
        onSuccess(data.participantInfo);
      } else {
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">
              Enter your registration details to access the project submission form
            </p>
          </div>
