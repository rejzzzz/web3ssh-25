...
export const Schedule = () => {
  ...
  const scheduleData = {
    '29 June 2025': [
      ...
      { time: '9:45-11:45', title: 'Coding session 1', topic: 'Solidity Session' },
      { time: '12:00-12:45', title: 'Key note 1', speaker: 'Ravikant Agarwal' },
      { time: '2:00-3:30', title: 'Coding session 2', topic: 'Solidity Session' },
      { time: '3:45-4:30', title: 'Fire-side Chat 1', last: true },
    ],
    '30 June 2025': [
      { time: '9:30-9:45', title: 'Assignment 1', first: true },
      { time: '9:45-11:45', title: 'Coding session 3', topic: 'Solidity Session' },
      { time: '12:00-12:45', title: 'Team Building 1' },
      { time: '2:00-3:30', title: 'Coding session 4', topic: 'Foundry Session' },
      { time: '3:45-4:30', title: 'Key note 2', speaker: 'Yip Thy Diep Ta', last: true },
    ],
    '01 July 2025': [
      { time: '9:30-9:45', title: 'Assignment 2', first: true },
      { time: '9:45-11:45', title: 'Coding session 5', topic: 'Foundry Session' },
      { time: '12:00-12:45', title: 'Fire-side Chat 2' },
      { time: '2:00-3:30', title: 'Coding session 6', topic: 'DeFI and NFT Session' },
      { time: '3:45-4:30', title: 'Key note 3', speaker: 'Sarah Benson', last: true },
    ],
    '02 July 2025': [
      { time: '9:30-9:45', title: 'Assignment 3', first: true },
      { time: '9:45-11:45', title: 'Coding session 7', topic: 'DeFI and NFT Session' },
      { time: '12:00-12:45', title: 'Key note 4', speaker: 'Kamlesh Nagware' },
      { time: '2:00-3:30', title: 'Coding session 8', topic: 'Web Integration Session' },
      { time: '3:45-4:30', title: 'Team Building 2', last: true },
    ],
    '03 July 2025': [
      { time: '9:30-9:45', title: 'Assignment 4', first: true },
      { time: '9:45-11:45', title: 'Coding session 9', topic: 'Web Integration Session' },
      { time: '12:00-12:45', title: 'Key note 5', speaker: 'Prasanna Lohar' },
      { time: '2:00-3:30', title: 'Coding session 10', topic: 'IPFS and Market places' },
      { time: '3:45-4:45', title: 'Feedback and testimonials' },
    ...
    '04 July 2025': [
      ...
      { time: '6:00 PM', title: 'Hackathon Check-in', last: true },
    ],
    '05 July 2025': [
      { time: '9:30 AM', title: 'Hackathon', first: true },
      { time: '6:00 PM', title: 'Hackathon Ends', last: true },
    ],
    '06 July 2025': [
      {
        time: '9:30 AM',
