  ...
  return (
    <div className="text-center mb-16">
      ...
      >
        ...
        <motion.h1
          className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-white via-purple-300 to-cyan-300 bg-clip-text text-transparent mb-6 relative"
          animate={{
        ...
        >
          <span className="relative">
            ...
            <motion.div
              ...
              className="absolute -top-2 -right-4 inline-block"
            >
        ...
        <motion.div
          ...
          className="absolute -top-6 right-1/4 flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full text-sm font-bold text-white shadow-lg"
        >
          <motion.div
      ...
      >
        ...
        <div className="text-gray-300 text-sm">
          ...
          <div>Filter • Sort • Search • Real-time Updates</div>
        </div>
      </motion.div>
    </div>
  );
