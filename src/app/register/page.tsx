                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-white mb-8">
                  ...
                  <div className="bg-white/5 p-6 rounded-xl backdrop-blur-md border border-white/10 h-full">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start">
                        ...
                        <span>Expert speakers from top blockchain companies and institutions</span>
                      </div>
                      <div className="flex items-start">
                        <span className="text-purple-300 mr-2 mt-1">•</span>
                        <span>Hands-on workshops on smart contracts, DApps, and blockchain fundamentals</span>
                      </div>
                      <div className="flex items-start">
                        <span className="text-purple-300 mr-2 mt-1">•</span>
                        <span>Keynote sessions on Web3 evolution, tokenization, and future trends</span>
                      </div>
                      <div className="flex items-start">
                        <span className="text-purple-300 mr-2 mt-1">•</span>
                        <span>Interactive panel discussions with industry leaders</span>
                      </div>
                      <div className="flex items-start">
                        <span className="text-purple-300 mr-2 mt-1">•</span>
                        <span>Hackathon with exciting prizes and recognition</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 p-6 rounded-xl backdrop-blur-md border border-white/10 h-full">
                    ...
                    <div className="space-y-2 mb-5">
                      ...
                      <div className="flex items-start">
                        <span className="text-purple-300 mr-2 mt-1">•</span>
                        <span>Comprehensive learning resources and materials</span>
                      </div>
                      <div className="flex items-start">
                        <span className="text-purple-300 mr-2 mt-1">•</span>
                      ...
                      <div className="flex items-start">
                        <span className="text-purple-300 mr-2 mt-1">•</span>
                        <span>Career guidance and placement prep sessions</span>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 bg-white/10 p-4 rounded-lg">
                      ...
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="font-bold text-purple-300">₹499</span>
                      </div>
                      <p className="text-xs text-white/70 mb-3">* Use a valid referral code when registering to avail the discount</p>
                    </div>
                  </div>
                </div>
  ...
  >
    <div className="relative p-8 md:p-10 before:absolute before:inset-0 before:bg-white/5 before:rounded-2xl">
      <div className="relative z-10">
          ...
          <div className="bg-white/5 p-6 rounded-xl backdrop-blur-md border border-white/10 h-full">
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <span>Register as an Ambassador at web3ssh.dev</span>
              </div>
              <div className="flex items-start">
                <span className="text-purple-300 mr-2 mt-1">2.</span>
                <span>Receive your unique referral code via email</span>
              </div>
              <div className="flex items-start">
                <span className="text-purple-300 mr-2 mt-1">3.</span>
                <span>Share your code with friends and communities</span>
              </div>
              <div className="flex items-start">
                <span className="text-purple-300 mr-2 mt-1">4.</span>
                <span>Get at least one person to use your referral code</span>
              </div>
              <div className="flex items-start">
                <span className="text-purple-300 mr-2 mt-1">5.</span>
                <span>Receive notification when someone uses your code</span>
              </div>
              <div className="flex items-start">
                <span className="text-purple-300 mr-2 mt-1">6.</span>
                <span>Complete registration at exclusive Ambassador Fare</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 p-6 rounded-xl backdrop-blur-md border border-white/10 h-full">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/90">T-Shirt + Custom Desk Mat</p>
              </div>
              <div className="bg-white/10 p-4 rounded-lg">
                <div className="font-semibold mb-2">Top 5 Ambassadors (15+ Registrations)</div>
                <p className="text-white/90">T-Shirt + Desk Mat + Special Prizes + Social Media Shoutout</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <p className="text-sm text-white/70 text-center mt-6">
          Ambassador registrations close on May 15, 2025. Limited slots available.
        </p>
      </div>
    </div>
  </div>
